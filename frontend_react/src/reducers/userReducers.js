...
export const userDetailsReducer = (state = userState, action) => {
  switch (action.type) {
...
export const userUpdateProfileReducer = (state = userState, action) => {
  switch (action.type) {
...
export const userUpdateProfilePhotoReducer = (state = userState, action) => {
  switch (action.type) {
