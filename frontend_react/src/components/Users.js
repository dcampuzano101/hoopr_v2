...
//           <div item xs={12} className={classes.mainHeaderWrapper}>
//             <h1 variant="h1" className={classes.componentHeader}>
//               Users
//             </h1>
//             <h3>basketball_icon</h3>
//           </div>
//           <div container xs={12} className={classes.mainComponentWrapper}>
...
//               </Typography>
//             </Grid>
//             <Grid item xs={12} className={classes.usersWrapper}>
